...
define('DB_REACT_DB_USER', 'root');
define('DB_REACT_DB_NAME', 'react_db');
//print("this is host\n");
//print ($hostname);
$hostname = 'localhost';
...
switch ($hostname) {
    case 'localhost':
        ...
        define('DB_REACT_DB_PASS', '');
        define('DB_REACT_DB_HOST', 'localhost');
        break;
    default:
        define('DB_DATA_PASS', '');
        define('DB_DATA_HOST', 'localhost');
...
class Database {
    ...
    public static function getReactDb() {
        return new Database('REACT_DB');
    }
